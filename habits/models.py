...
class Habit(models.Model):
    ...
    start_time = models.TimeField(verbose_name='start time', default='PT120S')
    ...
    related_habit = models.OneToOneField('self', on_delete=models.SET_NULL, null=True, blank=True,)
    periodicity = models.PositiveIntegerField(default=1,)
    reward = models.CharField(max_length=33, null=True, blank=True,)
    time_to_complete = models.DurationField(db_comment='ISO 8601 PT?S',)
